...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const body = await validateRequestBody(request, validationSchemas.rejectRun);
    ...
    // Log audit event
    await audit.agentApprovalRejected(updatedApproval.id, user.id, {
      runId: id,
      reason: body.reason,
    }, request);
